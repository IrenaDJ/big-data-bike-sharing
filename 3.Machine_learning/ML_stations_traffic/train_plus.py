...
def main(train_data_folder, model_path, onehot_path):
    ...
    encoder = OneHotEncoderEstimator(inputCols=["station_index"], outputCols=["station_vector"])
...
if __name__ == "__main__":
    ...
    parser.add_argument('one_hot_folder', type=str, 
                        help='a hdfs folder containing training data')
    parser.add_argument('model_data_folder', type=str, 
                        help='a local folder for saving trained model')

    args = parser.parse_args()
    main(args.train_folder, args.model_data_folder, args.one_hot_folder)